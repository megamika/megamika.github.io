    ...
    >
      <div className="header-container">
        <Link to="/" className="header-navlink">
          <div className="header-nameandtitle">
            <span className="header-name">
              <span className="">Mikael Zakoyan</span>
            </span>
            <span className="header-title">
              <span className="">Technical Des</span>
              <span className=""></span>
              <span className="">ign</span>
            </span>
          </div>
        </Link>
        <div className="header-socialandresume">
          <div className="header-social">
            <a
              href="https://www.instagram.com/megamika2/"
              target="_blank"
            ...
            <a
              href="https://twitter.com/MikaZakoyan"
              target="_blank"
              rel="noreferrer noopener"
          ...
          <a
            href="https://pdfhost.io/v/ZSj64gzP7_Resume"
            target="_blank"
            rel="noreferrer noopener"
            className="header-resume"
          >
            <span className="">R</span>
            <span className="">esume</span>
          </a>
        </div>
      </div>
    </header>
